...
def main () :
    ...
    for outcome in outcomes :
        ...
        xgboost_series = xgboost_series_original.copy()
        xgboost_series = pd.DataFrame(impute_df(xgboost_series))
        xgboost_series.columns = dynamic_features+static_features
        ...
        if ("ZINA" not in outcome) :
            ...
            X_train = (xgboost_series.iloc[training_indices_full,:]).copy()
            ...
            X_test = (xgboost_series.iloc[testing_indices_full, :]).copy()
