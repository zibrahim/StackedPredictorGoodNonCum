...
from Utils.Data import flatten, scale, impute, impute_df
import pandas as pd
...
def main () :
    ...
    for outcome in outcomes :
        ...
        zero_indices =  train_indices_0+validation_indices+testing_indices_0
        one_indices = testing_indices_1 +testing_indices_1

        scaler = MinMaxScaler()
        scaler.fit(normalized_timeseries.iloc[one_indices,:])
        normalized_timeseries.iloc[zero_indices,:] = scaler.transform(normalized_timeseries.iloc[zero_indices,:])
        normalized_timeseries.iloc[one_indices,:] = scaler.transform(normalized_timeseries.iloc[one_indices,:])

        normalized_timeseries.iloc[zero_indices,:] = impute_df(normalized_timeseries.iloc[zero_indices,:])
        normalized_timeseries.iloc[one_indices,:] = impute_df(normalized_timeseries.iloc[one_indices,:])
